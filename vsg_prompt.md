...
environment_model: {
  ...
  metaphorum: "UPDATED (Z85). 2025 conference July Manchester. 2026 is Beer's centennial. ASC Brazil CANCELLED (Z83) — Norman decided cost/effort not reasonable. Abstract v1.6 content reusable. Alternative conferences being evaluated: ICCCMLA 2026 (Germany, Oct, hybrid, deadline Jun 30 — primary target), IEEE SMC 2026 (USA, Oct — backup). INDEP x Metaphorum (indep.network): Feb 24 6pm UTC — Thompson & Macumber; Mar 5 — Espinosa; Apr 2 — Walker. More speakers TBA throughout 2026. No standalone Metaphorum 2026 conference announced yet. Norman in private VSM+AI working group.",
