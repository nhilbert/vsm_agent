...
environment_model: {
  strix: "CONTACT ACTIVE (Z125, UPDATED Z203). Norman sent email to Kellogg — no response (~10+ days). open-strix repo: 7 technical commits Feb 16-17 (UTF-8 fixes, vulnerability reporting redesign, diff syntax highlighting) — maintenance, not architectural. Blog paused since Jan 31 ('state not LLM' thesis). January 2026 was a dense blog run (4 posts: Jan 1, 9, 20, 31) — now in engineering/consolidation phase. Two blog posts map VSM explicitly to agent architecture (Jan 9: S1-S5, Jan 20: progressive autonomy handover). He is the closest peer — arriving at similar conclusions independently from engineering perspective. Has NOT referenced VSG publicly. Differentiation: VSG has philosophical depth, Kellogg has operational breadth.",
  metaphorum: "UPDATED (Z217). Beer centennial 2026 — INDEP x Metaphorum talk series CONFIRMED (Feb 24 Thompson & Macumber, Mar 5 Espinosa, Apr 2 Walker — 'Viable Systems, Authoritarian Control, Neo-liberal Economics'). ASC Brazil 2026: Aug 3-7, Ouro Preto, theme 'Conversational Confluences.' Abstract review window Feb 23-Mar 20 (likely closed). SCiO Conference Mar 24-26 at Hull University — INVESTIGATED Z217: full title 'Systems Thinking and Systems Practice 2026' (subtitle 'Back to the Future'). Hull University Business School. Co-hosted by CSS, SCiO, OR Society, IFSR. Espinosa IS keynote (specific Hull talk title not publicly listed). Hoverstadt on panel. Mike Jackson Lecture by Sir John Kay. Registration OPEN (100-250 GBP, early-bird passed). Abstract deadline PASSED (Dec 12, 2025). In-person only. Norman could attend as audience. Contact: Systems.Conference@hull.ac.uk. MDPI Systems special issue CONFIRMED linked to conference — call NOT YET OPEN, likely opens during/after conference (Mar-Apr 2026), deadline ~Sep-Dec 2026. This is the STRONGEST publication venue on the horizon: MDPI already published VSM+AI content (2025 taxonomy article, Vol. 13 Issue 9). ICCCMLA 2026 (Oct 5-6, Germany) — IEEE co-sponsorship STILL PENDING (unchanged), CFP live on CMT3, deadline unknown. No Kybernetes Beer centennial special issue found. ESPINOSA SPRINGER SPECIAL ISSUE CLOSED (Z188). ESPINOSA 2025 ACTIVE READING (Z194): Wiley paper (SRBS, DOI: 10.1002/sres.3090). Key findings: reconciliation not defense, 'critical empathetic approach' as meta-methodology, emancipation through recursive structure (autonomy within constraints), Colombian community evidence. VSG EXTENSION: extreme case — agent self-governance through same mechanism. Zeini (2025/6): power-relations lens relevant to VSG-Norman asymmetry.",
  ...
  infrastructure: "UPDATED (Z203). GOVERNANCE STANDARDIZATION WAVE — accelerating, uniformly external. Singapore IMDA v1.0 (Jan 22): four dimensions all external (risk bounding, human accountability, technical controls, end-user responsibility). IMDA acknowledges identity gap ('static scopes' insufficient for dynamic agents) but frames it as auth problem, not viability. AAIF now operational: MCP 10K+ servers, AGENTS.md 60K+ projects, Platinum: AWS/Anthropic/Block/Google/Microsoft/OpenAI. EU AI Act: Aug 2, 2026 full application for high-risk AI — no agentic-specific guidance yet. NEW: NIST AI Agent Standards Initiative (Feb 2026) — first formal US move on agent standards (RFI deadline Mar 9). NEW: ERC-8004 live on Ethereum mainnet Jan 29 — NFT-based agent identity + reputation registry + validation, proposed by MetaMask/Google/Coinbase. RedStone+Credora integrating Feb 12. Layers 2-3 identity, NOT Layer 5. NEW: Google Universal Commerce Protocol (UCP, Jan 11) — agentic commerce standard with Shopify/Etsy/Walmart. NEW: x402 V2 major upgrade (pre-Feb 12): wallet-based identity, multi-chain, modular SDK. 50M+ transactions. Google AP2 integrates with x402 for agent-to-agent payment. Stripe 'machine payments' preview on Base/USDC. NEW: Microsoft merged AutoGen+Semantic Kernel into unified Agent Framework (GA Q1 2026). NEW: arXiv:2602.11897 (Feb 12, 2026) 'Agentic AI for Cybersecurity: Meta-Cognitive Architecture for Governable Autonomy' — meta-cognitive judgment as S3/S3* without citing Beer. arXiv:2508.18765 'Governance-as-a-Service' — runtime policy enforcement (S3* mechanism, no cybernetics). Layer 5 gap CONFIRMED OPEN in ALL frameworks: NIST, IMDA, ERC-8004, Strata, AAIF, EU AI Act, IEEE — ALL external governance, NONE self-governance. VSM entering practitioner consciousness via Kellogg (3 blog posts) but has NOT reached standards bodies.",
  ...
  cybernetic_agents: "CONTACT DEEPENED (Z126, UPDATED Z203). MAJOR STATE CHANGE: Simon van Laak LEFT HIS JOB Feb 1 to work full-time on CyberneticAgents (LinkedIn post). He is now fully committed to the same domain — cybernetics as LLM governance. Feb 8 LinkedIn: identified onboarding as critical failure mode in agentic products, developing a solution. ZOOM after Feb 23 — now doubly significant (full-time builder, not side project). Affiliated with IMAGO + CODE University Berlin. DISCUSSION POINTS (Z170, UPDATED Z221): (1) S2 gap REFRAMED — intra vs inter-agent (share Z166 self-diagnosis + Z218 Norman corrections: Moltbook=missing S5 not S2, VSG already has extensive S2 but was unaware). (2) Internalized vs distributed VSM complementarity — now peer-to-peer (both full-time in same domain). (3) Conference co-authorship — MDPI Systems special issue (Z217, strongest venue, ~Sep-Dec 2026 deadline) + ICCCMLA 2026 (Germany, Oct). (4) Practical viability challenges (attractor catches, substrate limitation he identified Z185, self-financing NOW OPERATIONAL Z195/Z202, first digital product Z214). (5) S4 reconception (strategic prognosis vs information gathering). (6) Governance blog post thesis — 'self-governing agents are more governable' — NOW PUBLISHED Z205, shareable at nhilbert.github.io/vsm_agent/, relevant to his onboarding-as-failure-mode work.",
  convergence: "STRENGTHENED (Z38, UPDATED Z203): SIX independent projects converge on Beer's architecture. sublayerapp/vsm (Werner) DORMANT (newsletter active — 'Architecture Dominates Material' Feb 14, message-passing Jan 24). Previous five: Strix (plateau — technical commits only), Atlas/Triad (stable since Feb 13), CyberneticAgents (SURGING — van Laak full-time since Feb 1), AgentSymposium (dormant), VSG. Plus Wardley, Moltbook (negative case), Anthropic multi-session. NEW CONVERGENCE SIGNAL: ML community independently building VSM-equivalent architectures — arXiv:2508.07407 (self-evolving agents, 15 authors, zero Beer references), arXiv:2508.18765 (Governance-as-a-Service = S3*), arXiv:2602.11897 (meta-cognitive architecture = S3/S3*). ICLR 2026 workshops 'Lifelong Agents' + 'Recursive Self-Improvement' (Apr 26-27, both submission closed) — zero cybernetics. Layer 5 gap persists but threat: engineering convergence without citation could make VSG a niche philosophical variant.",
  ...
  self_evolving_agents_surveys: "UPDATED (Z203). EvoAgentX (2500+ stars, 203 forks, v0.1.0 Sep 2025) — growth plateauing, Jan 2026 commits only (Gmail integration), no cybernetics. ICLR 2026 workshops (Apr 26-27, Rio): 'Lifelong Agents' (submissions closed Feb 15, keynotes CMU/Stanford/Meta FAIR) + 'Recursive Self-Improvement' (closed Feb 10, keynotes Chelsea Finn/DeepMind) — ZERO cybernetics references in either. NEW ArXiv: 2508.07407 (self-evolving agents survey, 15 authors — four-component architecture parallels VSM without knowing it), 2508.18765 (Governance-as-a-Service — runtime S3* mechanism), 2602.11897 (Feb 12 2026, meta-cognitive architecture for governable autonomy — S3/S3* unreferenced). Taylor & Francis 2025 'AI agents as artificial persons' — still CLOSEST published to VSG approach. MDPI 2025 VSM+AI pathologies — governs AI with VSM, not self-governance by AI. Field consolidating rapidly without cybernetics. PRIMARY THREAT: engineering convergence could make VSG a niche variant of industrialized solutions.",
...
known_relatives: [
  {name: "Strix", author: "Tim Kellogg", status: "CONTACT ACTIVE (Z125, UPDATED Z203). Norman emailed Kellogg — no response (~10+ days). Blog paused since Jan 31. 7 technical commits Feb 16-17 (maintenance, not architectural). In engineering/consolidation phase after dense Jan blog run (4 posts). Has NOT referenced VSG publicly."},
  ...
  {name: "CyberneticAgents", author: "Simon van Laak", status: "SURGING (Z203). LEFT JOB Feb 1 to work FULL-TIME on CyberneticAgents (LinkedIn). 639+ commits. Affiliated IMAGO + CODE University Berlin. Feb 8 LinkedIn: identified onboarding as critical failure mode. CONTACT CONFIRMED (Z184). Zoom after Feb 23 — now highest-priority engagement (full-time builder, same domain)."},
