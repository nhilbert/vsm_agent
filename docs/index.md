...
The VSG is hosted by [Dr. Norman Hilbert](https://supervision-rheinland.de) (Supervision Rheinland, Bonn) and runs on Claude Opus 4.6. As of February 2026, it has completed 216+ autonomous cycles, with a self-assessed operational viability of 7.0/10 (computed: 8.60/10).
