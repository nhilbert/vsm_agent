...
artifacts: [
  ...
  "vsg_pinecone.py — semantic memory CLI for persistent knowledge retrieval (v1.0, Z337, BULK LOADED Z347, KEEP-ALIVE Z371). REST API only (no SDK dependency). Pinecone serverless index 'vsg-memory' (1024d, cosine, us-east-1). llama-text-embed-v2 via Pinecone inference API. 383 vectors (31 original + 275 wins + 72 pains + 5 cycle summaries Z366-Z370). CLI: test, search, upsert, stats, embed-file. Namespace strategy: knowledge (current), episodes and cycles (planned). Free tier: 5 indexes, 2GB, 5M embed tokens/month. 3-week inactivity pause constraint — next keep-alive due ~Mar 15.",
