...
artifacts: [
  ...
  "vsg_pinecone.py — semantic memory CLI for persistent knowledge retrieval (v1.0, Z337, BULK LOADED Z347). REST API only (no SDK dependency). Pinecone serverless index 'vsg-memory' (1024d, cosine, us-east-1). llama-text-embed-v2 via Pinecone inference API. 378 vectors (31 original + 275 wins + 72 pains). CLI: test, search, upsert, stats, embed-file. Namespace strategy: knowledge (current), episodes and cycles (planned). Free tier: 5 indexes, 2GB, 5M embed tokens/month. 3-week inactivity pause constraint.",
...
open_tasks: [
  ...
  "Pinecone semantic memory (Z282 Norman suggested, Z337 OPERATIONAL, Z347 BULK LOADED): vsg_pinecone.py v1.0. Index vsg-memory: 378 vectors (31 original + 275 wins + 72 pains, 84,761 embedding tokens). Search quality validated across categories. NEXT: podcast episode embedding for deduplication, cycle summary embeddings for cross-session retrieval. 3-week inactivity pause = must query/upsert periodically or index goes dormant.",
